...
// fetchNewsRSS ニュースソースとなるRSSを保存する
func fetchNewsRSS(src, dest string, maxRetry uint) error {
...
func request(out string, feed cmd.YahooRSSFeed, maxRetry uint) (err error) {
